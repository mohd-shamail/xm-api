...
const allFeesHistoryController = {
  async viewAllFeesHistory(req, res, next) {
    ...
    try {
      ...
      const feesHistory = await StudentFees.find({ user: _id })
...
module.exports = allFeesHistoryController;
